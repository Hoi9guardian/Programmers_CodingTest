...
입출력 예
participant	[참여명단]								completion [완주명단] 						return
...
// 참여명단 [ hashmap ] 완주명단 배열에 있는 사람을 하나씩 참여명단과 비교 후, 		
		...
		for(int i =0; i<completion.length;i++) {
			...
			if(hm.get(completion[i])==0) {
				hm.remove(completion[i]);
			}
			System.out.println(i+"번째_2"+hm);
		}
